 ...
 * - includeDeleted = false: Count only active projects (for PLUS tier)
 *
 * This allows FREE users to be limited to 3 total projects ever (can't game the system),
 * while PLUS users can delete to free up slots.
 */
 ...
 * - PLUS users don't see deleted projects in their count
